      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="glass-panel p-8 rounded-2xl border border-slate-200 dark:border-slate-800/80 shadow-sm space-y-4">
              ...
              <div className="text-slate-600 dark:text-slate-300 leading-relaxed space-y-4 text-base">
                ...
                <p>
                  I completed a 120-hour intensive summer training program jointly certified by the <strong className="text-slate-900 dark:text-white">National Telecommunication Institute (NTI)</strong> and <strong className="text-slate-900 dark:text-white">ITIDA</strong> in <strong className="text-emerald-600 dark:text-emerald-400">Full Stack Web Development using PHP</strong>, graduating with a high distinction score of <strong className="text-emerald-600 dark:text-emerald-400">95%</strong> (comprising 90 technical hours and 30 freelancing practice hours).
                </p>
                <p>
                  In parallel, I successfully passed the study and examination for the <strong className="text-slate-900 dark:text-white">HCIA-Cloud Computing V5.5 Course</strong> from <strong className="text-emerald-600 dark:text-emerald-400">Huawei ICT Academy</strong> (Certificate Code: 20260917000498), developing hands-on mastery over computing virtualization, virtual storage pools, and network isolation.
                </p>
                <p>
                  I also graduated from Round 5 of the <strong className="text-slate-900 dark:text-white">Digital Egypt Pioneers Initiative (DEPI)</strong> under the Ministry of Communications and Information Technology (MCIT), mastering personal branding, professional presentation, ATS-friendly CV engineering, and global freelancing client management.
                </p>
              </div>
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="flex items-start gap-2.5">
                  <CheckCircle className="w-4 h-4 text-cyan-500 mt-1 shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-2.5">
                  <CheckCircle className="w-4 h-4 text-emerald-500 mt-1 shrink-0" />
                  <div>
                    <h4 className="text-sm font-semibold text-slate-900 dark:text-white">Freelancing Ready</h4>
                    <p className="text-xs text-slate-500 dark:text-slate-400">30 hours ITIDA freelancing + MCIT DEPI Round 5.</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 rounded-2xl bg-white dark:bg-[#0c1222] border border-slate-200 dark:border-slate-800 shadow-sm space-y-4">
              ...
              <div className="bg-slate-50 dark:bg-slate-900/60 p-4 rounded-xl space-y-2 border border-slate-100 dark:border-slate-800">
                ...
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="font-mono text-emerald-600 dark:text-emerald-400">{education[0].period}</span>
                </div>
                <div className="flex justify-between items-center text-xs">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-500/10 via-cyan-500/5 to-transparent border border-emerald-500/20 space-y-3">
